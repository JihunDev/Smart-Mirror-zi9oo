(function(angular) {
    ...
    function MirrorCtrl(
        ...
        /*
         moment.locale(
         //////////////원래꺼가 이거임
          (typeof config.language !== 'undefined')?config.language.substring(0, 2).toLowerCase(): 'ko',
          {
            calendar : {
              lastWeek : '[Last] dddd',
              lastDay : '[Yesterday]',
        ...
        SpeechService.init({
            ...
            partialResult : function(result){
                console.log('speechService.partialResult!'); 
                $scope.partialResult = result;
                $timeout.cancel(resetCommandTimeout);
            },
            finalResult : function(result){
                console.log('speechService.finalResult!');
        ...
        _this.init = function() {
            ...
            var defaultView = function() {
            	...
            	console.log("Ok, going to default view...");
                $scope.focus = "default";
            }
            ...
            addCommand('list', function() {
            	...
            	//console.log("!!!!what can I say ����!!!!!!Here is a list of commands...");
...
*/
            ...
            addCommand('time_show', function(task) {
                 ...
                 if(responsiveVoice.voiceSupport()) {
                    ...
                    responsiveVoice.speak("현재 시간은"+moment().format('h:mm a')+"입니다","Korean Female");
                }
            });
/*
            // Control light
...
*/
            ...
            addCommand('subway', function(station,linenumber,updown) {
                //console.log("subway addCommand start");
                SubwayService.init(station).then(function(){
                //console.log("subway SubwayService Station start");
                SubwayService.getArriveTime(linenumber,updown).then(function(data){
                    //console.log("subway getArriveTime"+updown);
                  if(data != null){
