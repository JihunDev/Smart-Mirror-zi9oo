(function(annyang) {
    ...
    function MapService() {
        var service = {};
        service.center = "서울"; //default map locaiton
        ...
        service.generateMap = function(targetCenter, targetZoom) {
            ...
            var url = "https://maps.googleapis.com/maps/api/staticmap?center="+targetCenter+"&zoom="+targetZoom+
            ...
            /*
           return "https://maps.googleapis.com/maps/api/staticmap?center=Seattle,%20WA&zoom="+targetZoom+"&format=png&sensor=false&scale=2&size="+window.innerWidth+
            "x1200&maptype=roadmap&style=visibility:on|weight:1|invert_lightness:true|saturation:-100|lightness:1";
       */
        };
