...
(function (undefined) {
  ...
  root.annyang = {
    ...
    init: function(commands, resetCommands) {
    	console.log('	****annyang.js - init');
      //root.alert("Annyang-init");
      ...
      //recognition.lang = 'ko';	//@@Set lenguage
      ...
      recognition.onresult  = function(event) {
      	//console.log("annyang onresult!!!!");
        root.alert("annyang-onresult");
        if(pauseListening) {
          ...
          */
        	console.log('	**Speech heard, but annyang is paused - annyang.js');
        	return false;
        }
